    ...
    return (
        <div className="pb-10 bg-white p-5 text-black">
                    ...
                    <div className="w-5/6 login flex justify-around items-center">
                        ...
                        {user && user?.email ? (
                            <div className='flex flex-row gap-2'>
                                <Link to="/myList" className="btn bg-blue-700 text-white border-none rounded-xl">My List</Link>
            ...
            <div className="menu menu-horizontal bg-white w-full flex justify-around">
                <Link className='w-1/6 hover:bg-blue-600 border-black hover:border-none border-2 h-10 items-center justify-center flex rounded-xl lg:text-2xl md:text-xl text-l font-bold py-6' to={"/"}>Home</Link>
                <Link className='w-1/6 hover:bg-blue-600 h-10 hover:border-none border-black border-2 items-center justify-center flex rounded-xl lg:text-2xl md:text-xl text-l font-bold py-6' to={'/equipment'}>All Equipment</Link>
                <Link className='w-1/6 hover:bg-blue-600 hover:border-none border-black border-2 h-10 items-center justify-center flex rounded-xl lg:text-2xl md:text-xl text-l font-bold py-6' to={'/addequipment'}>Add Equipment</Link>
            </div>
            <hr className="border-t-2 border-black" />
        </div>
    );
